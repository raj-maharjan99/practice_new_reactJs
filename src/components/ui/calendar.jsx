  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-zinc-600 text-zinc-50 hover:bg-yellow-600 hover:text-zinc-50 focus:bg-green-400 focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900",
        day_today:
